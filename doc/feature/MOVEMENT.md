...
With Terrain Height Tools, the token also **auto-elevates** to sit on the terrain under it, as you drag, on drop, and when you first place it. Your Q/E offset stacks on top. You can turn that off three ways:
